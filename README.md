...
Posiciones de los distintos elementos en el mapa y revisar codigo.

Codigo echo con IA:

El codigo no es lo que esta echo con la IA, simplemente se le a pedido las posiciones, rotaciones, colores, etc.
